    ...
    amqp.connect('amqp://localhost', function (error0, connection) {
        ...
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume("product_updated", function (msg) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            product = _a.sent();
                            return [4 /*yield*/, productRepository.merge(product, {
            ...
            channel.consume("product_deleted", function (msg) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.deleteOne({
            ...
            app.post("/api/products/:id/like", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            product = _a.sent();
                            axios_1.default.post("http://localhost:8000/api/products/" + product.admin_id + "/like", {});
                            product.likes++;
                            return [4 /*yield*/, productRepository.save(product)];
                        case 2:
                            _a.sent();
